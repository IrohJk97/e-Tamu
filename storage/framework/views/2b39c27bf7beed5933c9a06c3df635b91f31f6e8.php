    ...
    <div class="ibox">
        <div class="ibox-head">
            ...
            <div class="btn-group m-b-10">
                ...
                <a href="<?php echo e(route('cetak.pegawai')); ?>" class="btn btn-danger btn-sm"><i class="fa fa-solid fa-download"></i> Donload PDF</a>
                    ...
                    <div class="form-group">
                        <label>Devisi Pegawai</label>
                          <select class="form-control" name="devisi">
                            ...
                            <?php $__currentLoopData = $devisi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="form-group">
                        <label>Jabatan Pegawai</label>
                          <select class="form-control" name="jabatan">
                            ...
                            <?php $__currentLoopData = $jabatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>"><?php echo e($item); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>                 
                    </div>
...
$(document).ready(function() {
    ...
    autoWidth: false,
    ajax: {
        url: '<?php echo e(route('pegawai.data')); ?>',
    },
    columns:[
...
$(document).on('click', '.editIcon', function(e) {
        ...
        let id = $(this).attr('id');
        $.ajax({
          url: '<?php echo e(route('pegawai.edit')); ?>',
          method: 'GET',
          data: {
            id: id,
...
$("#edit_form_devisi").submit(function(e) {
    ...
    $.ajax({
        url: '<?php echo e(route('pegawai.update')); ?>',
        method: 'POST',
        data: fd,
        cache: false,
        contentType: false,
...
$(document).on('click', '.deleteIcon', function(e) {
    ...
    Swal.fire({
        ...
        $.ajax({
            url: '<?php echo e(route('pegawai.destroy')); ?>',
            method: 'delete',
            data: {
            id: id,
            _token: csrf
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bahrululum/Documents/etamu/resources/views/admin/pegawai/index.blade.php ENDPATH**/ ?>