...
$(document).ready(function() {
    ...
    autoWidth: false,
    ajax: {
        url: '<?php echo e(route('jabatan.data')); ?>',
    },
    columns:[
...
$("#form-devisi").submit(function(e) {
    ...
    $("#btn").text('Menyimpan...');
    $.ajax({
    url: '<?php echo e(route('jabatan.store')); ?>',
    method: 'post',
    data: fd,
    cache: false,
    contentType: false,
...
$(document).on('click', '.editIcon', function(e) {
        ...
        let id = $(this).attr('id');
        $.ajax({
          url: '<?php echo e(route('jabatan.edit')); ?>',
          method: 'GET',
          data: {
            id: id,
...
$("#edit_form_devisi").submit(function(e) {
    ...
    $.ajax({
        url: '<?php echo e(route('jabatan.update')); ?>',
        method: 'POST',
        data: fd,
        cache: false,
        contentType: false,
...
$(document).on('click', '.deleteIcon', function(e) {
    ...
    Swal.fire({
        ...
        $.ajax({
            url: '<?php echo e(route('jabatan.destroy')); ?>',
            method: 'delete',
            data: {
            id: id,
            _token: csrf
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bahrululum/Documents/etamu/resources/views/admin/jabatan/index.blade.php ENDPATH**/ ?>