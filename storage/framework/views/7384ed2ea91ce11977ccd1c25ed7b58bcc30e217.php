...
$(document).ready(function() {
    ...
    autoWidth: false,
    ajax: {
        url: '<?php echo e(route('devisi.data')); ?>',
    },
    columns:[
...
$("#form-devisi").submit(function(e) {
    ...
    $("#btn").text('Menyimpan...');
    $.ajax({
    url: '<?php echo e(route('devisi.store')); ?>',
    method: 'post',
    data: fd,
    cache: false,
    contentType: false,
...
$(document).on('click', '.editIcon', function(e) {
        ...
        let id = $(this).attr('id');
        $.ajax({
          url: '<?php echo e(route('devisi.edit')); ?>',
          method: 'GET',
          data: {
            id: id,
...
$("#edit_form_devisi").submit(function(e) {
    ...
    $.ajax({
        url: '<?php echo e(route('devisi.update')); ?>',
        method: 'POST',
        data: fd,
        cache: false,
        contentType: false,
...
$(document).on('click', '.deleteIcon', function(e) {
    ...
    Swal.fire({
        ...
        $.ajax({
            url: '<?php echo e(route('devisi.destroy')); ?>',
            method: 'delete',
            data: {
            id: id,
            _token: csrf
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bahrululum/Documents/etamu/resources/views/admin/devisi/index.blade.php ENDPATH**/ ?>