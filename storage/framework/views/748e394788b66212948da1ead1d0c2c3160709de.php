    ...
    <div class="ibox">
        <div class="ibox-head">
            ...
            <div class="btn-group m-b-10">
                ...
                <a href="<?php echo e(route('cetak.tamu')); ?>" class="btn btn-danger btn-sm"><i class="fa fa-solid fa-download"></i> Donload PDF</a>
...
$(document).ready(function() {
    ...
    autoWidth: false,
    ajax: {
        url: '<?php echo e(route('admintamu.data')); ?>',
    },
    columns:[
...
$("#form-devisi").submit(function(e) {
    ...
    $("#btn").text('Menyimpan...');
    $.ajax({
    url: '<?php echo e(route('admintamu.store')); ?>',
    method: 'post',
    data: fd,
    cache: false,
    contentType: false,
...
$(document).on('click', '.editIcon', function(e) {
        ...
        let id = $(this).attr('id');
        $.ajax({
          url: '<?php echo e(route('admintamu.edit')); ?>',
          method: 'GET',
          data: {
            id: id,
...
$("#edit_form_devisi").submit(function(e) {
    ...
    $.ajax({
        url: '<?php echo e(route('admintamu.update')); ?>',
        method: 'POST',
        data: fd,
        cache: false,
        contentType: false,
...
$(document).on('click', '.deleteIcon', function(e) {
    ...
    Swal.fire({
        ...
        $.ajax({
            url: '<?php echo e(route('admintamu.destroy')); ?>',
            method: 'delete',
            data: {
            id: id,
            _token: csrf
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bahrululum/Documents/etamu/resources/views/admin/tamu/index.blade.php ENDPATH**/ ?>