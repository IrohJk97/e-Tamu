        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="getstarted scrollto" href="<?php echo e(route('login')); ?>">Login Admin</a></li>
                </ul>
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src="tamu/img/details-2.png" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4" data-aos="fade-right">
                        <img src="tamu/img/details-3.png" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src="tamu/img/details-4.png" class="img-fluid" alt="">
                    </div>
                    <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
        ...
        <section id="addtamu" class="contact">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <form action="<?php echo e(route('tamu.store')); ?>" method="post" role="form" class="php-email-form" data-aos="fade-up">
                            <?php echo csrf_field(); ?>
...
$(document).ready(function() {
    ...
    responsive: true,
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('tamu.data')); ?>',
            },
            columns:[
...
<?php /**PATH /Volumes/midata/project/etamu/resources/views/welcome.blade.php ENDPATH**/ ?>