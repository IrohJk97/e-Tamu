    ...
    <div class="row">
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-success color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong"><?php echo e($tamu); ?></h2>
                    <div class="m-b-5">Total Tamu</div><i class="ti-user widget-stat-icon"></i>
                    <div><i class="fa fa-level-up m-r-5"></i><small>
                    <a href="<?php echo e(route('admintamu')); ?>" style="color: white">Detail...</a>
                    </small></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-warning color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong"><?php echo e($pegawai); ?></h2>
                    <div class="m-b-5">Total Pegawai</div><i class="fa fa-money widget-stat-icon"></i>
                    <div><i class="fa fa-level-up m-r-5"></i>
                        <small>
                        <a href="<?php echo e(route('pegawai')); ?>" style="color: white">Detail...</a>
                        </small>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-danger color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong"><?php echo e($user); ?></h2>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bahrululum/Documents/etamu/resources/views/home.blade.php ENDPATH**/ ?>